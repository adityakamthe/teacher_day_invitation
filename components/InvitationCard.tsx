          ...
          <div className="relative z-10 flex flex-col items-center text-center space-y-4">
            ...
            <div className="w-full flex items-center justify-between gap-2 sm:gap-3 pt-1">
              ...
              <div className="flex flex-col items-center flex-shrink-0">
                <div className="relative w-13 h-13 sm:w-15 sm:h-15 w-[52px] h-[52px] sm:w-[60px] sm:h-[60px] rounded-full p-1 bg-gradient-to-br from-sand/90 via-ivory to-sand/60 border border-gold/40 shadow-sm flex items-center justify-center transition-transform duration-300 hover:scale-105">
                  <Image
            ...
            <div className="relative py-2 flex flex-col items-center">
              ...
              {/* Gold Divider Line with light sweep */}
            ...
            <div className="space-y-1">
              {isVip && (
                <div className="inline-flex items-center gap-1.5 px-3 py-0.5 rounded-full bg-gold-light/30 border border-gold/40 text-gold-deep text-[10px] uppercase font-bold tracking-widest mb-1">
                  <Sparkles className="w-3 h-3 text-flame" />
                  <span>VIP Dignitary Invitation</span>
                </div>
              )}
              <h2 className="font-serif font-bold italic text-2xl sm:text-[26px] text-maroon tracking-wide">
                {faculty.name}
              </h2>
            ...
            <p className="text-sm text-ink leading-relaxed max-w-[340px] pt-1">
              {customInvitationText ? (
                customInvitationText
              ) : isVip ? (
                <>
                  With highest honor and reverence,{" "}
                  <b className="font-semibold text-maroon">Dr. M. N. Jadhav (HOD)</b> and the
                  Department of Computer Engineering cordially invite you to grace our Teacher&rsquo;s Day Celebration.
                </>
              ) : (
                <>
                  On behalf of the students of Computer Engineering,{" "}
                  <b className="font-semibold text-maroon">{sender || event.hostedBy}</b> cordially
                  invites you to honor and celebrate the remarkable dedication of our teachers.
                </>
              )}
            </p>

            {/* Event Details Box */}
            <div className="w-full max-w-[340px] bg-paper/80 rounded-xl p-3.5 border border-gold/35 space-y-2.5 text-left shadow-sm">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-[11px] text-ink-soft font-medium">Teacher&rsquo;s Day Event</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-[11px] text-ink-soft font-medium">Kindly arrive 10 mins early</div>
                </div>
              </div>
